...
function setup() {
	...
	rope1=new Rope(bobObj1.body,roof.body,-100*2,0)
	rope2=new Rope(bobObj2.body,roof.body,-50*2,0)
	rope3=new Rope(bobObj3.body,roof.body,0*2,0)
	rope4=new Rope(bobObj4.body,roof.body,50*2,0)
	rope5=new Rope(bobObj5.body,roof.body,100*2,0)
